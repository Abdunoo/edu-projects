    ...
    >
      <div class="flex items-start justify-between gap-4 p-6">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-lg font-semibold">Create Class</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">
              Fill in the form to add a new class.
            </p>
          </div>
        </div>
...
definePageMeta({
  requiresAuth: true,
  permissionsAny: [Permission.CLASS_CREATE],
});
...
const createSchema = classSchema.partial({
  id: true,
  createdAt: true,
  updatedAt: true,
});
